...
setTimeout(function() {
    toggleSelector('keywords', 'category:privacy_preserving_fl');
    toggleSelector('keywords', 'category:non_iid_heterogeneity');
    toggleSelector('keywords', 'category:multimodal_ehr_fl');
    toggleSelector('keywords', 'category:novel_optimisation');
}, 2000);